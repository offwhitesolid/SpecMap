...
function ProcessPanel()
    ...
    Button FitFunction, pos={13.00,55.00},size={180.00,20.00},proc=ButtonProc,title="Fit Function to hsi",win=Process_Panel
    SetVariable fittresh, title="count threshold for fit",size={200,20},pos={310,55},proc=SetVarProc, value=Pathnum[14],win=Process_Panel
    ListBox list0,pos={200.00,55.00},size={100.00,60.00},listWave=root:packages:myfolder:fitfuncs
