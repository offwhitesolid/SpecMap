...
function Panel()
    ...
    SetVariable SpecNameDialog,pos={168.00,41.00},size={200.00,14.00},value= Path[1], title="Spec Name"
    SetVariable FirstHSINum,pos={410.00,41.00},size={200.00,14.00},value= Path[2], title="Start HSI count" 
...
Function LoadDF1(pathName, spechead, startHSIcount)
    ...
    make/O WL
    make/O BG
    make/O/N=(Ceil((xmax-xmin/dx)), 0) gridx
    make/O/N=(Ceil((ymax-ymin/dy)), 0) gridy
 	...
 	variable new
  	...
  	Make/O /N=((xmax-xmin)/dx, (xmax-xmin)/dy, 1023) hsidata
