...
class Exportframe:
    def __init__(self, Notebook, Nanomap) -> None:
        ...
        #self.plotapp = apc.PlotHSI(self.Notebook, get_hsi_func=lambda: apc.hsi_asarray(self.Nanomap.PixMatrix))
        self.plotapp = apc.PlotHSI(self.Notebook, get_hsi_func=apc.get_HSI)
