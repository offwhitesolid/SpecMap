...
class XYMap:
    ...
    def build_roi_frame(self, parframe):
        ...
        self.roi = tk.Entry(frame)
        self.roi.grid(row=1, column=0)
        self.roi.insert(0, 'roi0')
        b1 = tk.Button(frame, text="Highlight ROI", command= lambda: self.roihandler.construct(self.PixMatrix))
