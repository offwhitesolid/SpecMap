...
class ScaleBarApp:
    ...
    def save_image(self):
        ...
        draw.rectangle([self.bar_x, self.bar_y, self.bar_x + self.bar_length, self.bar_y + self.bar_height], fill="black")
        ...
        draw.text((self.bar_x, self.bar_y + self.bar_height + 5), self.text, fill="black", font=font)
