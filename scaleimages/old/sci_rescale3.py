...
class ScaleBarApp:
    ...
    def create_draggable_scale_bar(self):
        ...
        self.bar_length_pix = 30
        self.bar_height_pix = 5
        self.bar_length_mum = self.bar_length_pix * self.scalepixels
        self.bar_hight_mum = self.bar_height_pix * self.scalepixels
        ...
        self.text_id = self.canvas.create_text(self.bar_x, self.bar_y + self.bar_height + 10, anchor="nw", text=self.text, fill="white")
    ...
    def save_image(self):
        ...
        draw.rectangle([original_bar_x, original_bar_y, original_bar_x + original_bar_length, original_bar_y + original_bar_height], fill="white")
        ...
        draw.text((original_bar_x, original_bar_y + original_bar_height + int(5 * self.scale_ratio)), self.text, fill="white", font=font)
